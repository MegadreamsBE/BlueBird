-- This script is created by MegaDreams for [FUN] MegaDreams - Paradise Shooter, Don't even think about stealing it.
...
function ()
	...
	outputChatBox ( "#00FF00[#FFFFFF [FUN] MegaDreams - Paradise Shooter#00FF00]", 255, 255, 255, true)
	outputChatBox ( "#00FF00[*#FFFFFF Music: #64A6FFTacabro - Tacata #00FF00]", 255, 255, 255, true)
