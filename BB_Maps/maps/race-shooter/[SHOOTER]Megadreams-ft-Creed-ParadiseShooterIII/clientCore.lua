...
function ()
	...
	outputChatBox ( "#00FF00[#FFFFFF [Shooter] MegaDreams ft. CreeD - Paradise Shooter III#00FF00]", 255, 255, 255, true)
	outputChatBox ( "#00FF00[*#FFFFFF Music: #64A6FFColdplay - Paradise (Dubstep Remix)", 255, 255, 255, true)
	...
	outputChatBox ( "#00FF00[#FFFFFF Have fun, #64A6FFMegaDreams & CreeD #00FF00]", 255, 255, 255, true)
end
)
