function onClientResourceStart()
	...
	outputChatBox("",255,255,255,true)
	outputChatBox("",255,255,255,true)
	outputChatBox ("#7A02BFMoonlight #FFFFFFand #7A02BFQuantum #FFFFFFand #7A02BFUnknown #ffffffPresents #7A02BF: #FFFFFFInto Deep", 27, 89, 224, true)
	outputChatBox ("#FFFFFFPress #7A02BF'M'#FFFFFF to toggle the music On/Off.", 27, 89, 224, true)
	outputChatBox ("#FFFFFFVisit : #7A02BFwww.bth-team.co.cc", 27, 89, 224, true)
	...
	marker5b = createMarker(5124.3720703125, -2644.1728515625, 2080.4619140625, "corona", 2, 0, 0, 0, 0)
...
function markerHit(hitPlayer, matchingDimension)
	...
	elseif source == marker5a then
		local vehicle = getPedOccupiedVehicle(hitPlayer)
		if hitPlayer == getLocalPlayer() then
			if (alreadydid1 == true) and (alreadydid2 == true) and (alreadydid3 == true) and (alreadydid4 == true) then
				setElementRotation(vehicle, 0, 0, 270)
	...
	elseif source == marker5b then
		local vehicle = getPedOccupiedVehicle(hitPlayer)
		if hitPlayer == getLocalPlayer() then
			setElementRotation(vehicle, 0, 0, 270)
			setElementPosition(vehicle, 3544.7216796875, -1710.3603515625, 78.189979553223)
			setVehicleFrozen(vehicle, true)
			setTimer(setVehicleFrozen, 100, 1, vehicle, false)
			fadeCamera ( false, 0.0, 0, 0, 0 )
			setCameraTarget ( getLocalPlayer() )
